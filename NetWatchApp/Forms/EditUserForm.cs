...
namespace NetWatchApp.Forms
{
    public partial class EditUserForm : Form
    {
        ...
        public EditUserForm(User user)
        {
            ...
            txtIdentificationNumber.Text = _user.IdentificationNumber;
        ...
        private void InitializeComponent()
        {
            ...
            this.lblPasswordNote.Location = new System.Drawing.Point(150, 310);
            this.lblPasswordNote.Name = "lblPasswordNote";
            this.lblPasswordNote.Size = new System.Drawing.Size(200, 17);
            this.lblPasswordNote.Text = "Leave blank to keep current password";
            ...
            this.Text = "NetWatch App - Edit User";
        }
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                if (ValidateInput())
                {
                    ...
                    _user.IdentificationNumber = txtIdentificationNumber.Text.Trim();
