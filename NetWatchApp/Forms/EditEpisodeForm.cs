...
namespace NetWatchApp.Forms
{
    public partial class EditEpisodeForm : Form
    {
        ...
        private readonly Episode _originalEpisode;

        public EditEpisodeForm(Episode episode)
        {
            InitializeComponent();
            _originalEpisode = episode;
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            if (ValidateInput())
            {
                // Create a new episode with the updated values but preserve the ID
                Episode = new Episode
                {
                    Id = _originalEpisode.Id,
                    ContentId = _originalEpisode.ContentId,
